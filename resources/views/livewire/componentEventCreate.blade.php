        ...
        <div class="rounded-3" style="background-color: rgba(255, 255, 255, 0.918)">
          <form action="{{  route('events.store')  }}" method="POST" enctype="multipart/form-data" class="row justify-content-center flex-column m-4">
              ...
              <div class="form-group d-flex flex-row justify-content-center mb-2">
                ...
                <div class="col-md-10">
                  <input wire:model="title" name='title' type="text" class="form-control border-dark border-1 ms-1" id="title" >
                </div>
              </div>
              <div class="form-group d-flex flex-row justify-content-center mb-2">
                <label for="description" class="me-1 text">Description:  </label>
                <div class="col-md-10">
              ...
              <div class="form-group d-flex flex-row justify-content-center mt-4 mb-2">
                <label for="people" class="me-1 text-primary">MaxPeople:  </label>
                <div class="col-md-10">
                  <input wire:model="people" name='people' type="text" class="form-control border-dark border-1" id="people" >
                </div>  
              </div>
              <div class="form-group d-flex flex-row justify-content-center mb-2">
                <label for="date" class="me-1 text">dd/mm/aa:  </label>
                <div class="col-md-10">
                  <input wire:model="date" name='date' type="text" class="form-control border-dark border-1" id="date" >
                </div>  
              </div>
              <div class="form-group d-flex flex-row justify-content-center mb-2">
                <label for="time" class="me-5 text">Time:  </label>
                <div class="col-md-10">
                  <input wire:model="time" name='time' type="text" class="form-control border-dark border-1" id="time" >
                </div>  
              </div>
